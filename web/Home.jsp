<%-- 
    Document   : Home
    Created on : 03-Feb-2024, 12:23:03 pm
    Author     : hp
--%>
...
<html lang="en">
  ...
  <body style=background-color:#DCDCDC>
    <nav>
      <div class="nav__logo">AIRBUS</div>
      <ul class="nav__links">
        <li class="link"><a href="#">Home</a></li>
<!--        <li class="link"><a href="UserDashboard.jsp">userdashboard</a></li>-->
        <li class="link"><a href="signin.jsp">Login</a></li>
        <li class="link"><a href="sinup.jsp">Registration</a></li>
    ...
    <section class="section__container booking__container">
      ...
      <div class="form__group">
          ...
          <div class="input__content">
            <div class="input__group">
              <input type="number" Required name="guestno"/>
        ...
        <div class="form__group">
          ...
          <div class="input__content">
            <div class="input__group">
              <input type="text" name="depaturedate" Required/>
              <label>AGE</label>
            </div>
            <p> Give your age</p>
          </div>
...
<button class="btn" type="submit"><i class="ri-search-line"></i></button>
    ...
    <section class="section__container plan__container">
      ...
      <div class="plan__grid">
        ...
        <div class="plan__image">
          <img src="IMG/plan-1.jpg" alt="plan" />
          <img src="IMG/plan-2.jpg" alt="plan" />
          <img src="IMG/plan-3.jpg" alt="plan" />
        </div>
      </div>
    </section>
    ...
    <section class="section__container lounge__container">
      <div class="lounge__image">
        <img src="IMG/lounge-1.jpg" alt="lounge" />
        <img src="IMG/lounge-2.jpg" alt="lounge" />
      </div>
    ...
    <section class="section__container travellers__container">
      ...
      <div class="travellers__grid">
        <div class="travellers__card">
          <img src="IMG/traveller-1.jpg" alt="traveller" />
        ...
        <div class="travellers__card">
          <img src="IMG/traveller-2.jpg" alt="traveller" />
          <div class="travellers__card__content">
        ...
        <div class="travellers__card">
          <img src="IMG/traveller-3.jpg" alt="traveller" />
          <div class="travellers__card__content">
        ...
        <div class="travellers__card">
          <img src="IMG/traveller-4.jpg" alt="traveller" />
          <div class="travellers__card__content">
            <img src="IMG/client-4.jpg" alt="client" />
            <h4>Daniel Taylor</h4>
            <p>Malaysia</p>
          </div>
        </div>
