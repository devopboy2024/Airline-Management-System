 ...
 * @author hp
 */
public class AdminFlightView extends HttpServlet {
            ...
            if ( searchid==null) {
                ...
                try{
                    int id=Integer.parseInt(searchid);
                     ...
                     AddFlight ss=dao.EditFlight(id);
                     if(ss!=null){
//                   out.println(ss.getDepaturetime());
               HttpSession session=request.getSession();
               session.setAttribute("flight",ss);
               response.sendRedirect("Demo2.jsp");
                     }
                else{
                   out.print("Something Error in Servlet");
                   }
                }catch(Exception e){
                    e.printStackTrace();
               }
