...
public class LoginServlet extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         User returnData=dao.loginusers(username, password);//return data ma data aaya after the connection estblishment
...
//              
               ...
               session.setAttribute("currentUser",returnData);//The returnData, which likely contains user information, is stored in the session attribute with the key "currentUser".
