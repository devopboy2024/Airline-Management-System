...
<html lang="en">
  ...
  <body>
        ...
        <div class="nav_menu" id="nav_menu">
          ...
          <ul class="nav_menu_list">
            <li class="nav_menu_item">
              <a href="AddFlight.jsp" class="nav_menu_link">AddFlight</a>
            </li>
            <li class="nav_menu_item">
              <a href="FlightAdminView.jsp" class="nav_menu_link">view details</a>
            </li>
            <li class="nav_menu_item">
              <a href="FlightAdminBookingStatus.jsp" class="nav_menu_link">Booking</a>
            </li>
            <li class="nav_menu_item">
    ...
    <!-- ==== SCRIPT.JS ==== -->
    <script src="JS/userdahsboard.js"></script>
  </body>
</html>
